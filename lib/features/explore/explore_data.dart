...
final List<TouristSpot> kVRTourSpots = [
  ...
  TouristSpot(
    ...
    city: 'Sinacaban',
    vrPanoramaUrl: 'assets/images/AMORAP.jpg',
    vrLink: '',
    hasVR: true,
    latitude: 8.2847,
    longitude: 123.8456,
...
final List<TouristSpot> kMockSpots = [
  ...
  TouristSpot(id: 'bless_amare_sunrise_beach', name: 'Bless Amare Sunrise Beach', category: 'Beach', imageUrl: 'assets/images/Baliangao - Cabgan Island.jpg', distance: 45.2, rating: 4.8, description: 'Baliangao Beach in Barangay Tugas. Day use entrance: Adults ₱80, Seniors ₱60, Kids ₱30. Cottages and tables available. Overnight stay open 24 hours.', city: 'Baliangao', latitude: 8.6167, longitude: 123.5667, vrPanoramaUrl: 'assets/images/Baliangao - Cabgan Island.jpg', hasVR: true),
  ...
  TouristSpot(id: 'piduan_falls', name: 'Piduan Falls', category: 'Falls', imageUrl: 'assets/images/Piduan Falls Donvic.jpg', distance: 55.8, rating: 4.7, description: 'Also known as Curtain Falls — majestic multi-layered waterfall with cold crystal-clear water at Mount Malindang. Entrance ₱100 (shuttle + pool). Sitio Piduan, Barangay Napangan.', city: 'Don Victoriano Chiongbian', latitude: 8.2542, longitude: 123.5642, vrPanoramaUrl: 'assets/images/Piduan Falls Donvic.jpg', hasVR: true),
  ...
  TouristSpot(id: '9', name: 'Aloran Viewpoint', category: 'Mountain', imageUrl: 'assets/images/aloran.jpg', distance: 20.0, rating: 4.5, description: 'Scenic landscapes and welcoming communities in Aloran.', city: 'Aloran', latitude: 8.4146, longitude: 123.8222, vrPanoramaUrl: 'assets/images/aloran.jpg', hasVR: true),
  ...
  TouristSpot(id: '13', name: 'Lopez Jaena Beachfront', category: 'Beach', imageUrl: 'assets/images/Lopez Jaena.jpg', distance: 40.0, rating: 4.3, description: 'Coastal living and beaches in Lopez Jaena.', city: 'Lopez Jaena', latitude: 8.5524, longitude: 123.7652, vrPanoramaUrl: 'assets/images/Lopez Jaena.jpg', hasVR: true),
