...
final List<TouristSpot> kVRTourSpots = [
  TouristSpot(
    ...
    rating: 4.8,
    description:
        'Sprawling city plaza with green lawns, pathways, and waterfront promenade. Explore in immersive 360° VR.',
    city: 'Oroquieta City',
  ...
  TouristSpot(
    ...
    distance: 25.3,
    rating: 4.7,
    description: 'AMORAP — Maldives-inspired eco-luxury park with overwater villas, lagoons, and coastal adventure in Sinacaban.',
    city: 'Sinacaban',
...
final List<TouristSpot> kMockSpots = [
  ...
  TouristSpot(id: '9', name: 'Aloran Viewpoint', category: 'Mountain', imageUrl: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800', distance: 20.0, rating: 4.5, description: 'Scenic landscapes and welcoming communities in Aloran.', city: 'Aloran', latitude: 8.4146, longitude: 123.8222, hasVR: false),
